...
{
    private static void assertRows(Object[][] actual, Object[]... expected)
    {
        Assert.assertEquals("Row count mismatch", expected.length, actual.length);
        for (int i = 0; i < expected.length; i++)
            Assert.assertArrayEquals("Row " + i + " mismatch", expected[i], actual[i]);
    }
    ...
    public void testRemoteQuorumWritesTwoDatacenters() throws Exception
    {
                                      ...
                                      .start())
        {
            ...
            dc1Node.runOnInstance(() -> {
                ...
                DatabaseDescriptor.setRemoteQuorumTargetDataCenters(Collections.singletonMap(local, "datacenter2"));
            });
    ...
    public void testRemoteQuorumOverwriteLocalQuorumWritesTwoDatacenters() throws Exception
    {
                ...
                .start())
        {
            ...
            IInvokableInstance dc1Node = cluster.get(1);
            dc1Node.runOnInstance(() -> DatabaseDescriptor.setEnableRemoteQuorumWriteOverride(false));
    ...
    public void testRemoteQuorumOverwriteLocalQuorumReadsTwoDatacenters() throws Exception
    {
                ...
                .start())
        {
            ...
            IInvokableInstance dc1Node = cluster.get(1);
            dc1Node.runOnInstance(() -> DatabaseDescriptor.setEnableRemoteQuorumReadOverride(false));
    ...
    /**
     * Partition range read at REMOTE_QUORUM when local replicas are unavailable.
     */
    @Test
