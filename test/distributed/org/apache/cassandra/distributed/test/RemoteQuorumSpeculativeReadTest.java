    ...
    public void tokenReadRemoteQuorumSpeculatesWhenAllowed() throws Exception
    {
                                      ...
                                      .start())
        {
            ...
            dc1.runOnInstance(() -> {
                ...
                ReplicaPlan.ForTokenRead plan = ReplicaPlans.forRead(ks, token, null, ConsistencyLevel.REMOTE_QUORUM, AlwaysSpeculativeRetryPolicy.INSTANCE);
    ...
    public void rangeReadRemoteQuorumDoesNotSpeculate() throws Exception
    {
                                      ...
                                      .start())
        {
            ...
            dc1.runOnInstance(() -> {
                ...
                ReplicaPlan.ForRangeRead plan = ReplicaPlans.forRangeRead(ks, null, ConsistencyLevel.REMOTE_QUORUM, FULL_BOUNDS, 1);
